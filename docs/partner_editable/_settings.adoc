...
:quickstart-project-name: quickstart-amazon-vpc-traffic-mirroring
:partner-product-name: Monitor Amazon EC2 instance network traffic using Suricata 
...
:quickstart-contributors: Vinod Shukla, AWS Integration & Automation Team
